...
$where = ["categoria_id = 1"]; // << SOMENTE HARDWARE
...
.check input[type="checkbox"] {
    ...
    box-shadow: none !important;   /* remove glow verde */
    outline: none !important;      /* remove marcação verde */
    filter: none !important;       /* remove filtro verde */
}
     ...
     <aside class="col-md-3">
            <div class="filter-box">
                <form method="GET" id="formFiltros">
                    ...
                    <label class="check"><input type="checkbox" name="sub[]" value="8" <?= in_array(8, $selectedSubs) ? 'checked' : '' ?>> Gabinete</label><br>
                    <label class="check"><input type="checkbox" class="check" name="sub[]" value="9" <?= in_array(9, $selectedSubs) ? 'checked' : '' ?>> Monitor</label><br>
                    <label class="check"><input type="checkbox" class="check" name="sub[]" value="10" <?= in_array(10, $selectedSubs) ? 'checked' : '' ?>> Teclado</label><br>
                    <label class="check"><input type="checkbox" class="check" name="sub[]" value="11" <?= in_array(11, $selectedSubs) ? 'checked' : '' ?>> Mouse</label><br>
                    <label class="check"><input type="checkbox" class="check" name="sub[]" value="12" <?= in_array(12, $selectedSubs) ? 'checked' : '' ?>> Headset</label><br>
                    <label class="check"><input type="checkbox"  class="check" name="sub[]" value="13" <?= in_array(13, $selectedSubs) ? 'checked' : '' ?>> Cooler</label><br>
                     <label class="check"><input type="checkbox" class="check" name="sub[]" value="14" <?= in_array(14, $selectedSubs) ? 'checked' : '' ?>> Water Cooler</label><br>
                     <label class="check"><input type="checkbox" class="check" name="sub[]" value="15" <?= in_array(15, $selectedSubs) ? 'checked' : '' ?>> Webcam</label><br>
                     <label class="check"><input type="checkbox" class="check" name="sub[]" value="16" <?= in_array(16, $selectedSubs) ? 'checked' : '' ?>> Mousepad</label><br>
                    <hr>
                    <hr>
